                ...
                {PRESET_COLORS.map(c => (
                  <button
                    ...
                    className={`w-7 h-7 rounded-full cursor-pointer flex items-center justify-center transition-all duration-150 ${
                      form.color === c ? 'ring-2 ring-[var(--gray-800,#1f2937)] ring-offset-2' : ''
                    }`}
                    style={{ background: c }}
                  >
