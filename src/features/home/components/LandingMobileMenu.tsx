        ...
        createPortal(
          <>
            ...
            <div
              ...
              aria-modal="true"
              aria-label="Menu"
              className={`fixed top-0 right-0 h-dvh w-[min(300px,82vw)] bg-white shadow-[-10px_0_40px_rgba(15,23,42,0.18)] transition-transform duration-280 z-1001 flex flex-col p-[0.9rem_1.15rem_1.4rem]`}
              style={{
