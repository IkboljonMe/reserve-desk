...
export function FinalCta({ t, demoUrl }: { t: Translate; demoUrl: string }) {
  return (
    <section className="max-w-285 mx-auto px-6 pb-16">
      <div className="lp-final-cta px-8 py-12 text-center bg-[linear-gradient(135deg,#14192a_0%,#1e2540_60%,#2a1e55_100%)] shadow-[0_24px_60px_rgba(15,23,42,0.35)]">
        ...
        <a
          href={demoUrl}
          className="inline-flex items-center gap-2 px-7.5 py-3.25 no-underline bg-(image:--brand-gradient) text-white font-bold shadow-[0_8px_24px_rgba(99,102,241,0.45)]"
        >
