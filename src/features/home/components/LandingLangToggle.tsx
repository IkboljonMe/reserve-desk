  ...
  return (
    <div ref={rootRef} className="relative inline-block text-left select-none">
      <button
        ...
        aria-label="Language"
        className="h-[38px] w-[38px] sm:w-auto justify-center sm:justify-between px-0 sm:px-3.5 inline-flex items-center gap-1.75 rounded-[10px] bg-[var(--gray-100)] hover:bg-[var(--gray-200)] text-[var(--gray-700)] cursor-pointer border border-[var(--surface-border)] transition-all duration-150 text-[0.8rem] font-semibold"
      >
