...
import { GuestServicesClient, type GuestServiceLabels, type GuestServiceDto } from '@/features/menu/guest/GuestServicesClient'
...
export default async function GuestServicesPage({
  ...
  const serviceDocs = await GuestService.find({ hotelId: hotel._id, active: true })
  ...
  const labels: GuestServiceLabels = {
    ...
    requestSentDesc: t('requestSentDesc') || 'Ваш запрос передан на ресепшн. Мы свяжемся с вами в ближайшее время.',
    close: t('close'),
